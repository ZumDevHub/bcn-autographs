      ...
      >
        ...
        {sortDropMenu && (
          <div className="absolute flex flex-col top-full left-0 w-full rounded-md bg-white border-1 border-gray-300 p-1 text-sm cursor-pointer shadow-xl shadow-gray-400">
            <div onClick={() => setSortBy(sortAlternatives[0])} className="mb-1 hover:bg-gray-200 md:mb-0">
              {t[locale][sortAlternatives[0]]}
            </div>
            <div onClick={() => setSortBy(sortAlternatives[1])} className="mb-1 hover:bg-gray-200 md:mb-0">
              {t[locale][sortAlternatives[1]]}
            </div>
            <div onClick={() => setSortBy(sortAlternatives[2])} className="mb-1 hover:bg-gray-200 md:mb-0">
